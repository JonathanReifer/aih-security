...
**YOU ARE IN: `aih_security/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/aih_security/` (rig root) or other directories
...
**Your mail address:** `aih_security/polecats/chrome`
**Your rig:** aih_security
**Your Witness:** `aih_security/witness`
...
| Ask Witness for help | `gt mail send aih_security/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`aih_security/witness`) when:
...
```bash
gt mail send aih_security/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
